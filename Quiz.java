...
//Find below the Answers Array of the above Questions
        ...
        opt1.setBounds(170,480,700,30);
        opt1.setBackground(Color.WHITE);
        opt1.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt1);
        
        opt2 = new JRadioButton();
        opt2.setBounds(170,515,700,30);
        opt2.setBackground(Color.WHITE);
        opt2.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt2);
        
        opt3 = new JRadioButton();
        opt3.setBounds(170,555,700,30);
        opt3.setBackground(Color.WHITE);
        opt3.setFont(new Font("Dialog",Font.PLAIN,20));
        add(opt3);
        
        opt4 = new JRadioButton();
        opt4.setBounds(170,595,700,30);
        ...
        lifeline.setBounds(1000,510,200,40);
    ...
    public void paint(Graphics g)
    {
        ...
        String time = "Time left  "+ timer + " seconds";  //20sec
        g.setColor(Color.red);
        g.setFont(new Font("Tahoma", Font.BOLD,20));
        
        if(timer >0)
        {
            g.drawString(time, 1000, 470);
        }
        else 
        {
